...
export default function Checkout() {
  ...
  const getDeliveryCharge = () =>
    cartItems.reduce((acc, item) => acc + (item.deliveryCharge || 0), 0);
  const getSubtotal = () =>
    cartItems.reduce((acc, item) => acc + getItemTotal(item), 0);
            ...
            <table className="table site-block-order-table mb-5">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td className="text-black">₹{getDeliveryCharge()}</td>
                </tr>
                <tr>
                  <td className="text-black font-weight-bold">
                    <strong>Cart Subtotal</strong>
                  </td>
                  <td className="text-black">₹{getSubtotal()}</td>
                </tr>
                <tr>
                  <td className="text-black font-weight-bold">
